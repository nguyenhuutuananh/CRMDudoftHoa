...
foreach ($rResult as $aRow) {
    ...
    $options.='<div class="dropdown" style="position: absolute;">
                    ...
                    <ul class="dropdown-menu">
                      ...
                      <li><a href="'.admin_url().'debit/pdf/' . $aRow['tbldebit.id'].'?pdf=true" target="_blank">Liên 1</a></li>
...
//    $options .= icon_btn('debit/pdf/'. $aRow['tbldebit.id'] .'?pdf=true' , 'print', 'btn-default', array('target'=>'_blank'));
    $options .= icon_btn('debit/pdf/'. $aRow['tbldebit.id'] .'?print=true' , 'file-pdf-o', 'btn-default '.$mleft30, array('target'=>'_blank'));

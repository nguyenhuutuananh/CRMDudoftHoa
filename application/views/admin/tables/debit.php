...
foreach ($rResult as $aRow) {
    ...
    $options = '';
    $options .= icon_btn('debit/pdf/'. $aRow['tbldebit.id'] .'?pdf=true' , 'file-pdf-o', 'btn-default', array('target'=>'_blank'));
    $options .= icon_btn('debit/pdf/'. $aRow['tbldebit.id'] .'?print=true' , 'print', 'btn-default', array('target'=>'_blank'));
    $options .= icon_btn('debit/pdf/'. $aRow['tbldebit.id'] , 'download', 'btn-default', array('target'=>'_blank'));
    $row[] = $options;

        ...
        <div class="tab-content">
            ...
            <?php echo form_open_multipart($this->uri->uri_string(), array('class' => 'client-form', 'autocomplete' => 'off')); ?>
                ...
                <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
                    ...
                    echo  render_input('code_vouchers', _l('code_vouchers'),$code_vouchers,'text',array('readonly'=>true));
                    ?>
                </div>
...
<script>
    ...
    var item_debit_contract = <?php echo json_encode($debit_contract);?>;
    console.log(item_debit_contract);
    var itemList_debit_contract_purchase = <?php echo json_encode($debit_contract_purchase);?>;
    ...
    var findItem = (id,type) => {
        ...
        if(type==1)
        {
            $.each(item_debit_contract, (index,value) => {
        ...
        {
            $.each(itemList_debit_contract_purchase, (index,value) => {
                if(id == index) {
                    itemResult = value;
                    return false;
                }
